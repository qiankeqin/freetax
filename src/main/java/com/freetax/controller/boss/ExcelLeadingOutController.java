...
public class ExcelLeadingOutController {
     ...
     * @return
     */
    @ApiOperation(value = "会员用户导出Excel", notes = "会员用户导出Excel", response = Response.class)
     ...
     * @return
     */
    @ApiOperation(value = "用户咨询记录导出Excel", notes = "用户咨询记录导出Excel", response = Response.class)
     ...
     * @return
     */
    @ApiOperation(value = "资讯文章导出Excel", notes = "资讯文章导出Excel", response = Response.class)
