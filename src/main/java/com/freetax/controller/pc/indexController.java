...
public class indexController {
    ...
    public Response queryBannerByType(@ApiParam(value = "类型 3:税务筹划背景图片 4:税务筹划顶部banner " +
            "5:资讯顶部banner 6:收入对比图 7：问答banner 8：招商banner 9：联系我们banner") @RequestParam(required = false) String type) {
        Response response = new Response();
